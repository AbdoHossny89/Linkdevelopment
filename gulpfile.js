var gulp = require('gulp'),
    ...
    sass = require('gulp-sass')(require('sass'));    htmlmin = require('gulp-htmlmin'),
    connect = require('gulp-connect'),
    imagemin = require('gulp-imagemin'),
    sourcemaps = require('gulp-sourcemaps');

gulp.task('image', function () {
    return gulp.src('link_ui/images/*')
        .pipe(imagemin())
...
gulp.task('js', function () {
    return gulp.src(['link_ui/js/plugins/popper.js', 'link_ui/js/**/*.*', 'link_ui/js/*.js']) // al folder al feh al files bt3te
...
gulp.task('css', function () {
    return gulp.src('link_ui/scss/style.scss')
...
gulp.task('watch', function () {
    ...
    gulp.watch('link_ui/scss/**/*.scss', gulp.series('css')) //ay folder gwa al css w ay file amtddao css 
    gulp.watch(['link_ui/js/**/*.*', 'link_ui/js/*.js'], gulp.series('js')) //ay folder gwa al css w ay file amtddao css 
    gulp.watch('link_ui/*.html', gulp.series('html'))
    gulp.watch('link_ui/images/*', gulp.series('image'))
